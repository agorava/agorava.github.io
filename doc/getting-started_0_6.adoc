...
By default the servlet is expect to be launch in a popup since it'll close the window at the end of treatment, you can change this behavior by overriding `renderResponse` method in `org.agorava.core.cdi.web.OAuthCallBackCdiServlet`
